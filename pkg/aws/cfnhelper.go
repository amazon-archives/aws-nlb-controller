...
//GetStackOutputValueforKey takes the stack Information and a outputKey as input and returns the Outputs value for that key
func GetStackOutputValueforKey(stack *cloudformation.Stack, outputKey string) *string {
